...
ani = animation.FuncAnimation(fig, animate, frames=30, interval=10, blit=True)
#ani = animation.FuncAnimation(fig, animate, frames=30, interval=10, repeat_delay=3000, blit=True)
