...
image_file_descriptor__forcing = "a_nc_avgs_wc30"

d = netCDF4.Dataset(surface_current_file, 'r')
...
u_surf_annual = d['ubar'][-1,:,:]
v_surf_annual = d['vbar'][-1,:,:]
...
u_surf_annual, v_surf_annual = roms_at_rho_trim(u_surf_annual, v_surf_annual)
