...
isoline_file_in = "/home/blaughli/tracking_project_v2/misc/z_boxes/a_islands/z_output/isodistance_lonlat_coords_rho_coastline_wc15n_island_1_and_2_blob.npz"
d = np.load(isoline_file_in)
isoline_lonlat_island_blob1 = d["combined_isoline_lonlat"]
...
###ax.plot(isoline_lonlat_continent[:,0],list(reversed(isoline_lonlat_continent[:,1])))
###ax.plot(list(reversed(isoline_lonlat_continent[:,0])),list(reversed(isoline_lonlat_continent[:,1])))
...
ax.plot(isoline_lonlat_island_blob1[:,0],isoline_lonlat_island_blob1[:,1])
