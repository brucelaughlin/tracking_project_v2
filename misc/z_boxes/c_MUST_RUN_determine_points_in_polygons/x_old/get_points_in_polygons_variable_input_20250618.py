...
output_file_stem_lonlat = f"points_in_boxes_lon_lat_combined_{grid_name}_singleCellPolygons.p"
output_file_stem_iijj = f"points_in_boxes_ii_jj_combined_{grid_name}_singleCellPolygons.p"
