    ...
    variables = LagrangianArray.add_variables([
        ('Kz', {'dtype': np.float32,
            ...
            'description': 'Vertical diffusivity',
                               'default': 0}),
        ('dKdz', {'dtype': np.float32,
                               'units': 'm/s',
            'description': 'Vertical gradient of vertical diffusivity',
                               'default': 0}),
...
class OceanDrift(OpenDriftSimulation):
    ...
    def vertical_mixing(self, store_depths=False):
        ...
        # bruce
        logger.debug(f'vertical_mixing:timestep = {dt_mix}')
        ...
        dKdz_mean = dKdz_mean/ntimes_mix
        Kz_mean = Kz_mean/ntimes_mix
        self.elements.dKdz = dKdz_mean
        self.elements.Kz = Kz_mean
