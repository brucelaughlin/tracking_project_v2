...
grid_path_in = '/home/blaughli/tracking_project_v2/grid_data/wc15n_grd.nc'
...
for polygon_dex in range(num_polygons):
    ...
    #ax.annotate(polygon_dex, xy = xy_loc, color='k', ha="center", va="center", fontsize=10, weight="bold")
