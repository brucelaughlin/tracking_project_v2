# copied from "plot_con_seasonal_pDrakeCompare_v3.py"

numFloatsFile = 177660
...
#title_add1 = f"nflts1 = {num_floats}, nflts2 = {numFloatsFile}, nset1 = {num_settlers}, nset2 = {num_settlers_check}, settle_strength1 = {{num_floats/num_settlers}.03f}, settle_strength2 = {{numFloatsFile/num_settlers_check}.03f}"
title_add1 = f"nflts1 = {num_floats}, nflts2 = {numFloatsFile}, nset = {num_settlers}, settle_strength1 = {num_settlers/num_floats:.03f}, settle_strength2 = {num_settlers/numFloatsFile:.03f}"

fig_fullTitle = fig_fullTitle + "\n" + title_add1
