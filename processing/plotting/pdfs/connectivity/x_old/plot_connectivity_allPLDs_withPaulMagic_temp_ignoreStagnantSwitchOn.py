...
#            break
        ...
        #        prePdf_arrays_connectivity = d['prePdf_arrays_connectivity']
            ...
            if annualOnlySwitch:
                figure_file_leaf_pre = f"{figure_title_base}_pld_{pld_string}_annual"
                #figure_file_leaf = figure_title_base + "_annual" + '.png'
            else:
                figure_file_leaf_pre = f"{figure_title_base}_pld_{pld_string}_seasonal"
                #figure_file_leaf = figure_title_base + "_seasons" + '.png'
                
            if ignoreStagnantSwitch:
                figure_file_leaf = f"{figure_file_leaf_pre}_ignoreStagnantFloats.png"
            else:
                figure_file_leaf = f"{figure_file_leaf_pre}_includeStagnantFloats.png"
...
#           print('hi2')
    ...
    #fig.suptitle(figure_title_base)
