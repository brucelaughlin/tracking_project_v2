# Copied from "stablePlotter_update2"; now just plot histograms/raw settlement counts

annualOnlySwitch = True

script_version = "raw_counts_v1"
...
figure_file_leaf = connectivity_file_stem + "_" + "plotScript_" + script_version + '.png'
