...
# I think I can only really make one histogram at a time
release_cell_index = 200
settle_cell_index = 200
...
#connectivity_distance_histogram_list = []
...
for connectivity_data_file in file_list:
    ...
    for pld_index in range(len(pld_list)):
        ...
        if file_counter == 1:
            ...
            connectivity_distance_histogram_list.append([])
            ...
            if annualOnlySwitch:
                ...
                connectivity_distance_histogram_list[pld_index].append(np.zeros_like(pdf))
                if pld_index == 0:
        ...
        if annualOnlySwitch:
            pdf = np.copy(prePdf_arrays_connectivity[annualSeasonIndex,pld_index])
            connectivity_distance_histogram_list[pld_index][0] += pdf
            if pld_index == 0:
            ...
            for season_index in pdfs_to_plot_indices:
                pdf = np.copy(prePdf_arrays_connectivity[season_index,pld_index])
                connectivity_distance_histogram_list[pld_index][season_index] += pdf
                if pld_index == 0:
...
for pld_index in range(len(pld_list)):
    ...
    #    if annualOnlySwitch:
    #        connectivity_distance_histogram_list[pld_index][adjusted_season_index] = connectivity_distance_histogram_list[pld_index][adjusted_season_index] / release_counts_per_polygon_array_list[adjusted_season_index][:, np.newaxis] 
    #        ####connectivity_distance_histogram_list[pld_index][0] = connectivity_distance_histogram_list[pld_index][0] / release_counts_per_polygon_array_list[0][0][:, np.newaxis] # Now need to access element 0
    #        # Testing
    #        #connectivity_distance_histogram_list[pld_index][adjusted_season_index] = connectivity_distance_histogram_list[pld_index][adjusted_season_index] 
    #    else:
    #        connectivity_distance_histogram_list[pld_index][adjusted_season_index] = connectivity_distance_histogram_list[pld_index][adjusted_season_index] / release_counts_per_polygon_array_list[adjusted_season_index][:, np.newaxis] 
    #        #connectivity_distance_histogram_list[pld_index][adjusted_season_index] = connectivity_distance_histogram_list[pld_index][adjusted_season_index] / release_counts_per_polygon_array_list[adjusted_season_index][0][:, np.newaxis] # Now need to access element 0
    #        # Testing
    #        #connectivity_distance_histogram_list[pld_index][adjusted_season_index] = connectivity_distance_histogram_list[pld_index][adjusted_season_index] 
            
        connectivity_distance_histogram_list[pld_index][adjusted_season_index] = connectivity_distance_histogram_list[pld_index][adjusted_season_index] / release_counts_per_polygon_array_list[adjusted_season_index][:, np.newaxis] 

        #if np.amax(connectivity_distance_histogram_list[pld_index][adjusted_season_index]) > pdf_max_val:
        #    pdf_max_val = np.amax(connectivity_distance_histogram_list[pld_index][adjusted_season_index])
        #if np.amin(np.ma.masked_invalid(connectivity_distance_histogram_list[pld_index][adjusted_season_index])) < pdf_min_val:
        #    pdf_min_val = np.amin(np.ma.masked_invalid(connectivity_distance_histogram_list[pld_index][adjusted_season_index]))
    ...
    print(f"Number of pdfs: {len(connectivity_distance_histogram_list[pld_index])}")
    ...
    for season_index in pdfs_to_plot_indices:
        ...
        pdf_plot = connectivity_distance_histogram_list[pld_index][season_index]
        #pdf_plot = connectivity_distance_histogram_list[pld_index][season_index][0,:,:]   # Why is this neccesary now???
