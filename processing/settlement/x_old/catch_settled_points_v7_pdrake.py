...
#                    num_outofbounds += 1
    ...
    save_output_full_path = os.path.join(save_output_directory, save_output_file_name + "_pld_{}_{}_v{}".format(pld_array[pld_dex,0],pld_array[pld_dex,1], script_version))
