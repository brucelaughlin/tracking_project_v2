...
script_version = "singleFileParralel_addPDrakeOption_test4"

# For test4 version, we need to create a fake "status" field for the pDrake files.  Since "0" means "active", I"m going to try just assigning 0 for all 
# timesteps of all particles
