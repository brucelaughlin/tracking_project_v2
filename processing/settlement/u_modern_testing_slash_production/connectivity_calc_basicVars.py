# first modified 2025/04/08

# This version will accommodated Mercator data.  So, no O2,pH, etc...
# Copied from connectivity_calc_ReproducesPatrickButOld_update1.py
...
#            break
        ...
        print(f'File loop took {(end_file_time-start_file_time)/60} minutes')
