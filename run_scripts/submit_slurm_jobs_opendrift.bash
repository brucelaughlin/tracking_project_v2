...
# Say we have 8 config files (ie 8 slurm calls, ie 8 nodes' worth of work), and 3 nodes to work with.  We want to run in SERIAL, so that
# file 4 starts as soon as file 1 finishes, file 5 starts as soon as file 2 finishes, etc.  Looks like this:
# 1 -> 4 -> 7
# 2 -> 5 -> 8
# 3 -> 6
